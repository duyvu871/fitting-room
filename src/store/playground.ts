...
/** Playground ID */
export const playgroundIdAtom = atom<string | undefined>(undefined);
// -----------------------------
...
export const categorizeShapeKeyAtom = atom(() => (keyName: string): ShapeKeyCategory => {
...
export const setCombinedShapeKeyValueAtom = atom(
  null,
  (get, _set, params: { upKey: string; downKey: string; value: number }) => {
...
export const setModelVisibleAtom = atom(
  null,
  (get, set, params: { name: string; visible: boolean }) => {
...
export const applyImportedConfigAtom = atom(
  null,
  (get, set, params: { config: PlaygroundConfig }) => {
